...
DumperApp.prototype = $extend(hxd_App.prototype,{
	init: function() {
		var hmd = hxd_Res.get_loader().loadModel("skel.hmd").toHmd();
...
Dumper.main = function() {
	hxd_Res.set_loader(new hxd_res_Loader(new hxd_fs_EmbedFileSystem(haxe_Unserializer.run("oy8:skel.hmdty8:cube.fbxty8:cube.hmdty9:Model.FBXtg"))));
	new DumperApp();
};
